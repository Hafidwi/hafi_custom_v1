        ...
        if (frm.doc.docstatus === 1 && frm.doc.outstanding_amount > 0) {
            frm.add_custom_button(__('Journal Entry'), function() {
                ...
                frappe.model.with_doctype('Journal Entry', function() {
                    ...
                    row1.account = frm.doc.credit_to;
                    row1.party_type = 'Supplier';
                    row1.party = frm.doc.supplier;
                    row1.debit_in_account_currency = frm.doc.outstanding_amount;
                    row1.reference_type = 'Purchase Invoice';
